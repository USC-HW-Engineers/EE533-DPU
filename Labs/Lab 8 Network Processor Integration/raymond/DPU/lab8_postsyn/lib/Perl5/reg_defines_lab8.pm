...
# Description: CPU + GPU Network Processor
#
#############################################################
...
@EXPORT = qw(
                ...
                GPU_CPU_IMEM_ADDR_REG
                GPU_CPU_IMEM_DATA_REG
                GPU_GPU_IMEM_ADDR_REG
                GPU_GPU_IMEM_DATA_REG
                GPU_SYS_CTRL_REG
                GPU_GPU_PC_REG
                GPU_CYCLE_COUNTS_REG
                GPU_GPU_STATUS_REG
...
sub DEVICE_PROJ_NAME () { "Network Processor"; }
sub DEVICE_PROJ_DESC () { "CPU + GPU Network Processor"; }
...
sub GPU_CPU_IMEM_ADDR_REG ()   { 0x2000100;}
sub GPU_CPU_IMEM_DATA_REG ()   { 0x2000104;}
sub GPU_GPU_IMEM_ADDR_REG ()   { 0x2000108;}
sub GPU_GPU_IMEM_DATA_REG ()   { 0x200010c;}
sub GPU_SYS_CTRL_REG ()        { 0x2000110;}
sub GPU_GPU_PC_REG ()          { 0x2000114;}
sub GPU_CYCLE_COUNTS_REG ()    { 0x2000118;}
sub GPU_GPU_STATUS_REG ()      { 0x200011c;}
