...
def DEVICE_PROJ_DESC ():
    return "CPU + GPU Network Processor"
...
def GPU_CPU_IMEM_ADDR_REG (): 
    return 0x2000100

def GPU_CPU_IMEM_DATA_REG (): 
    return 0x2000104

def GPU_GPU_IMEM_ADDR_REG (): 
    return 0x2000108

def GPU_GPU_IMEM_DATA_REG (): 
    return 0x200010c

def GPU_SYS_CTRL_REG ():      
    return 0x2000110

def GPU_GPU_PC_REG ():        
    return 0x2000114

def GPU_CYCLE_COUNTS_REG ():  
    return 0x2000118

def GPU_GPU_STATUS_REG ():    
    return 0x200011c
...
__main__.nf_regmap.update({
    ...
    0x2000100 : "GPU_CPU_IMEM_ADDR_REG",
    0x2000104 : "GPU_CPU_IMEM_DATA_REG",
    0x2000108 : "GPU_GPU_IMEM_ADDR_REG",
    0x200010c : "GPU_GPU_IMEM_DATA_REG",
    0x2000110 : "GPU_SYS_CTRL_REG",
    0x2000114 : "GPU_GPU_PC_REG",
    0x2000118 : "GPU_CYCLE_COUNTS_REG",
    0x200011c : "GPU_GPU_STATUS_REG",
