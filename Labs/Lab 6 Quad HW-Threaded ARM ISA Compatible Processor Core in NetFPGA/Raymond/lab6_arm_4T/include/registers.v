...
`define CPU_IMEM_ADDR          4'h0
`define CPU_IMEM_DATA          4'h1
`define CPU_DMEM_ADDR          4'h2
`define CPU_DMEM_DATA          4'h3
`define CPU_CPU_CTRL           4'h4
`define CPU_CURRENT_PC         4'h5
`define CPU_DMEM_DATA_LOW_RD   4'h6
`define CPU_DMEM_DATA_HIGH_RD  4'h7
`define CPU_CYCLE_COUNTS       4'h8
