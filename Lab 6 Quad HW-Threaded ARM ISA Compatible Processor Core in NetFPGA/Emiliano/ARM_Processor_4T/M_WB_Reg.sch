...
BEGIN SCHEMATIC
    ...
    BEGIN SHEET 1 3520 5440
        ...
        END INSTANCE
        BEGIN INSTANCE XLXI_85 1408 4464 R0
        END INSTANCE
        BEGIN BRANCH M_ID(1:0)
            WIRE 1328 4240 1408 4240
        END BRANCH
        BEGIN BRANCH WB_ID(1:0)
            WIRE 1792 4240 1872 4240
        END BRANCH
        IOMARKER 1328 4240 M_ID(1:0) R180 28
        IOMARKER 1872 4240 WB_ID(1:0) R0 28
        IOMARKER 1328 4432 CLR R180 28
    END SHEET
END SCHEMATIC
