...
# File: projects/lab6_arm_4T/include/cpu.xml
def CPU_IMEM_ADDR_REG ():         
    return 0x2000200

def CPU_IMEM_DATA_REG ():         
    return 0x2000204

def CPU_DMEM_ADDR_REG ():         
    return 0x2000208

def CPU_DMEM_DATA_REG ():         
    return 0x200020c

def CPU_CPU_CTRL_REG ():          
    return 0x2000210

def CPU_CURRENT_PC_REG ():        
    return 0x2000214

def CPU_DMEM_DATA_LOW_RD_REG ():  
    return 0x2000218

def CPU_DMEM_DATA_HIGH_RD_REG (): 
    return 0x200021c

def CPU_CYCLE_COUNTS_REG ():      
    return 0x2000220
...
__main__.nf_regmap.update({
    ...
    0x2000200 : "CPU_IMEM_ADDR_REG",
    0x2000204 : "CPU_IMEM_DATA_REG",
    0x2000208 : "CPU_DMEM_ADDR_REG",
    0x200020c : "CPU_DMEM_DATA_REG",
    0x2000210 : "CPU_CPU_CTRL_REG",
    0x2000214 : "CPU_CURRENT_PC_REG",
    0x2000218 : "CPU_DMEM_DATA_LOW_RD_REG",
    0x200021c : "CPU_DMEM_DATA_HIGH_RD_REG",
    0x2000220 : "CPU_CYCLE_COUNTS_REG",
